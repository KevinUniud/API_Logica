...
for path_suffix, operation_id, summary, payload_model, examples, handler in [
    ...
    ("generate-formula", "generator_generate_formula", "Genera una formula in sintassi Prolog (profondita automatica)", AutoDepthRequest, AUTO_DEPTH_EXAMPLES, lambda payload: (orchestrator.generate_formula_json(variables=payload.variables, use_all=payload.use_all, timeout=payload.timeout, seed=payload.seed, bridge=_build_bridge(), allow_spoken_mode=payload.allow_spoken_mode).get("formula_spoken") if payload.allow_spoken_mode else generator.generate_formula(variables=payload.variables, use_all=payload.use_all, timeout=payload.timeout, seed=payload.seed, bridge=_build_bridge()))),
    ("generate-formula-json", "generator_generate_formula_json", "Genera una formula come JSON (profondita automatica)", AutoDepthRequest, AUTO_DEPTH_EXAMPLES, lambda payload: orchestrator.generate_formula_json(variables=payload.variables, use_all=payload.use_all, timeout=payload.timeout, seed=payload.seed, bridge=_build_bridge(), allow_spoken_mode=payload.allow_spoken_mode)),
    ("generate-formula-by-variable-count", "generator_generate_formula_by_variable_count", "Genera una formula in sintassi Prolog con un numero specifico di variabili", FormulaByVariableCountRequest, FORMULA_BY_VARIABLE_COUNT_EXAMPLES, lambda payload: (orchestrator.generate_formula_by_variable_count_json(variable_count=payload.variable_count, use_all=payload.use_all, timeout=payload.timeout, seed=payload.seed, bridge=_build_bridge(), allow_spoken_mode=payload.allow_spoken_mode).get("formula_spoken") if payload.allow_spoken_mode else generator.generate_formula_by_variable_count(variable_count=payload.variable_count, use_all=payload.use_all, timeout=payload.timeout, seed=payload.seed, bridge=_build_bridge()))),
    ("generate-formula-by-variable-count-json", "generator_generate_formula_by_variable_count_json", "Genera una formula con numero variabili esplicito e la restituisce come payload JSON", FormulaByVariableCountRequest, FORMULA_BY_VARIABLE_COUNT_EXAMPLES, lambda payload: orchestrator.generate_formula_by_variable_count_json(variable_count=payload.variable_count, use_all=payload.use_all, timeout=payload.timeout, seed=payload.seed, bridge=_build_bridge(), allow_spoken_mode=payload.allow_spoken_mode)),
    ("build-exercise", "generator_build_exercise", "Costruisce un esercizio a partire da una formula", GeneratorExprRequest, GENERATOR_EXPR_EXAMPLES, lambda payload: generator.build_exercise(expr=payload.expr, wrong_answers_count=payload.wrong_answers_count, bridge=_build_bridge(), seed=payload.seed, timeout=payload.timeout, allow_spoken_mode=payload.allow_spoken_mode)),
    ...
    ("multiple-questions", "generator_multiple_questions", "Costruisce piu domande in una singola chiamata e le mescola", MultipleQuestionsRequest, MULTIPLE_QUESTIONS_EXAMPLES, lambda payload: orchestrator.multiple_questions([item.model_dump() for item in payload.questions], seed=payload.seed, bridge=_build_bridge())),
    ("build-exercise-json-string", "generator_build_ex_json", "Costruisce un esercizio e lo serializza come stringa JSON", GeneratorExprRequest, GENERATOR_EXPR_EXAMPLES, lambda payload: orchestrator.build_ex_json(expr=payload.expr, bridge=_build_bridge(), seed=payload.seed, wrong_answers_count=payload.wrong_answers_count, timeout=payload.timeout, allow_spoken_mode=payload.allow_spoken_mode)),
    ("build-exercise-from-depth-json-string", "generator_build_ex_depth_json", "Costruisce un esercizio con variabili automatiche e lo serializza come stringa JSON", GeneratorAutoDepthRequest, GENERATOR_DEPTH_EXAMPLES, lambda payload: orchestrator.build_ex_depth_json(use_all=payload.use_all, timeout=payload.timeout, seed=payload.seed, wrong_answers_count=payload.wrong_answers_count, bridge=_build_bridge(), allow_spoken_mode=payload.allow_spoken_mode)),
    ("build-truth-value-options-question-json-string", "generator_build_tvq_json", "Costruisce la domanda con opzioni vere/false e la serializza come JSON", TruthValueOptionsRequest, TRUTH_VALUE_OPTIONS_EXAMPLES, lambda payload: orchestrator.build_tvq_json(predicate_count=payload.predicate_count, true_options_count=payload.true_options_count, false_options_count=payload.false_options_count, timeout=payload.timeout, seed=payload.seed, bridge=_build_bridge(), allow_spoken_mode=payload.allow_spoken_mode)),
